...
public sealed class RemainingParametersSuppressorTests : AnalyzerTestBase<RemainingParametersSuppressor>
{
    [Fact]
    ...
    public async Task DoNotSuppressRemainingParametersDiagnosticInNonOptionsType(string sequenceBaseType)
    {
        var source = $$"""
    ...
    [Fact]
    public async Task DoNotSuppressNonSequenceRemainingParametersDiagnosticInOptionsType()
    {
        var source = """
            using System.Collections.Generic;
    ...
    [InlineData("IReadOnlyCollection")]
    [InlineData("IReadOnlyList")]
    public async Task SuppressSequenceRemainingParametersDiagnosticInOptionsType(string sequenceBaseType)
    {
        var source = $$"""
            using System.Collections.Generic;
